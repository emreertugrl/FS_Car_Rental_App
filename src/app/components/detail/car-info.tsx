      ...
      <div>
        ...
        <div className="flex gap-2 my-3 items-center">
          {new Array(5).fill("").map((i, key) => (
            <FaStar className={key < 4 ? "text-yellow-400" : "text-zinc-400"} />
          ))}

          <span className="text-zinc-400 text-sm">440+ Yorum</span>
        </div>
        <p className="leading-8 tracking-wide text-xl text-zinc-700 my-14">{car.description}</p>
